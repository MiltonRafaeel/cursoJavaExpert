...
public class UserService implements UserDetailsService {
	...
	public UserDTO findById(Long id) {
		...
		User entity = obj.orElseThrow(() ->new ResourceNotFoundException("nao encontrado"));
	...
	public UserDTO insert(UserInsertDTO dto) {
		...
		entity.setPassword(passwordEnconder.encode(dto.getPassword())); // agora gera o hash da senha
